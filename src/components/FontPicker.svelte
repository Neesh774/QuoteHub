<script>
	import { fontOptions } from '../assets/options.json';
	export let selectedFont = 'Inter';
...
<div class="fontWrap">
	...
	<div class="content">
		...
		<p style={`font-family: ${selectedFont}`}>QuoteHub</p>
	</div>
</div>
<div class="fontSizeWrap">
	...
	<div class="content">
		<input type="range" max={40} min={5} bind:value={fontSize} />
	</div>
</div>
